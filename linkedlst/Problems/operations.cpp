...
Node* inserec(Node* head,int i,int data){
    ...
    Node* x= inserec(head->next,i-1,data);
    head->next=x;
...
Node* delNode(Node* head, int i){
    ...
    Node* b=a->next;
    temp->next=b;
    delete a;//to clear out the memory
    }
    return head;
}

Node* delNode_rec(Node* head,int i){
    ...
    Node* x= delNode_rec(head->next,i-1);
    head->next=x;
...
// int main(){
//     int t,i,data;
//     //Efficient method of taking input
...
//     //insertion recursive
//     /*cout<<"Enter the data location: \n";
//     cin>>data;
//     Node* headnew=inserec(head,i,data);
//     print(headnew);*/

//     //deletion recursive
//     Node* headnew=delNode_rec(head,i);
//     print(headnew);
//     print(head);
// }
